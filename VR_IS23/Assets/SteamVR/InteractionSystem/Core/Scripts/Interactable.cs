...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Interactable : MonoBehaviour
    {
        ...
        public Material customHightlightMat; // i added
        private bool hasCustomMat = false;
...
#endif
            // i added entire conditional
            if (customHightlightMat != null) {
                hasCustomMat = true;
            }
        ...
        protected virtual void CreateHighlightRenderers()
        {
            ...
            for (int skinnedIndex = 0; skinnedIndex < existingSkinnedRenderers.Length; skinnedIndex++)
            {
                ...
                for (int materialIndex = 0; materialIndex < materials.Length; materialIndex++)
                {
                    ...
                    if (hasCustomMat)
                    {
                        materials[materialIndex] =customHightlightMat;
                    }
                    else
                    {
                        materials[materialIndex] = highlightMat; // only original line within for loop
                    }
                }
